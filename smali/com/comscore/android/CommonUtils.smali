...
.method public static getApplicationSize(Landroid/content/Context;)Landroid/graphics/Point;
    ...
    invoke-static {p0}, Lhk/a;->i(Landroid/view/WindowManager;)Landroid/view/WindowMetrics;

    move-result-object p0

    invoke-static {p0}, Lhk/a;->h(Landroid/view/WindowMetrics;)Landroid/view/WindowInsets;
    ...
    invoke-static {v0, v1}, Lhk/a;->d(Landroid/view/WindowInsets;I)Landroid/graphics/Insets;

    move-result-object v0

    invoke-static {v0}, Landroidx/appcompat/widget/k1;->C(Landroid/graphics/Insets;)I
    ...
    invoke-static {v0}, Landroidx/appcompat/widget/k1;->y(Landroid/graphics/Insets;)I

    move-result v1

    invoke-static {v0}, Landroidx/appcompat/widget/k1;->D(Landroid/graphics/Insets;)I

    move-result v0

    add-int/2addr v0, v1

    invoke-static {p0}, Lhk/a;->e(Landroid/view/WindowMetrics;)Landroid/graphics/Rect;
