.class public final Lcom/rctitv/data/mapper/StoryQueryToStoryMapper;
.super Lv3/a;
.source "SourceFile"
...
.method public constructor <init>(Lcom/rctitv/data/util/DisplayHelper;)V
    ...
    .line 8
    .line 9
    iput-object p1, p0, Lcom/rctitv/data/mapper/StoryQueryToStoryMapper;->displayHelper:Lcom/rctitv/data/util/DisplayHelper;
...
.method public map(Ltp/a4;)Lcom/rctitv/data/model/StoryModel;
    .locals 38
    ...
    .line 3
    iget-object v4, v1, Ltp/a4;->a:Ljava/util/List;
    ...
    check-cast v5, Ltp/u3;

    .line 5
    iget-object v6, v5, Ltp/u3;->g:Ljava/util/List;
    ...
    .line 8
    iget-object v7, v5, Ltp/u3;->a:Ljava/lang/Integer;
    ...
    .line 9
    iget-object v8, v5, Ltp/u3;->d:Ljava/lang/String;

    invoke-virtual {v6, v8}, Lcom/rctitv/data/model/Story;->setProgramTitle(Ljava/lang/String;)V

    .line 10
    iget-object v9, v0, Lcom/rctitv/data/mapper/StoryQueryToStoryMapper;->displayHelper:Lcom/rctitv/data/util/DisplayHelper;

    .line 11
    iget-object v10, v1, Ltp/a4;->b:Ltp/x3;

    if-eqz v10, :cond_4

    iget-object v11, v10, Ltp/x3;->a:Ljava/lang/String;
    ...
    .line 13
    iget-object v13, v5, Ltp/u3;->b:Ljava/lang/String;
    ...
    .line 15
    iget-object v11, v5, Ltp/u3;->f:Ljava/util/List;
    ...
    .line 19
    iget-object v13, v12, Ltp/w3;->b:Ljava/lang/String;

    .line 20
    invoke-virtual {v14, v13}, Lcom/rctitv/data/GptStoryAds;->setPath(Ljava/lang/String;)V

    .line 21
    iget-object v13, v12, Ltp/w3;->a:Ljava/lang/Integer;
    ...
    .line 22
    iget-object v12, v12, Ltp/w3;->c:Ljava/util/List;
    ...
    .line 27
    iget-object v7, v15, Ltp/t3;->a:Ljava/lang/String;

    .line 28
    invoke-virtual {v4, v7}, Lcom/rctitv/data/AdsParam;->setName(Ljava/lang/String;)V

    .line 29
    iget-object v7, v15, Ltp/t3;->b:Ljava/lang/String;
    ...
    .line 34
    iget-object v5, v5, Ltp/u3;->g:Ljava/util/List;
    ...
    .line 37
    iget-object v12, v7, Ltp/b4;->a:Ljava/lang/Integer;
    ...
    .line 39
    iget-object v12, v7, Ltp/b4;->c:Ljava/lang/Integer;
    ...
    .line 40
    iget-object v12, v7, Ltp/b4;->b:Ljava/lang/String;

    invoke-virtual {v11, v12}, Lcom/rctitv/data/model/Story$StoryDetail;->setExternalLink(Ljava/lang/String;)V

    .line 41
    invoke-virtual {v11, v8}, Lcom/rctitv/data/model/Story$StoryDetail;->setProgramTitle(Ljava/lang/String;)V

    .line 42
    iget-object v13, v7, Ltp/b4;->f:Ljava/lang/String;

    invoke-virtual {v11, v13}, Lcom/rctitv/data/model/Story$StoryDetail;->setTitle(Ljava/lang/String;)V

    .line 43
    iget-object v13, v7, Ltp/b4;->g:Ljava/lang/String;

    invoke-virtual {v11, v13}, Lcom/rctitv/data/model/Story$StoryDetail;->setSwipeType(Ljava/lang/String;)V

    .line 44
    iget-object v14, v7, Ltp/b4;->i:Ljava/lang/String;

    invoke-virtual {v11, v14}, Lcom/rctitv/data/model/Story$StoryDetail;->setBackgroundColorCode(Ljava/lang/String;)V

    .line 45
    iget-object v14, v0, Lcom/rctitv/data/mapper/StoryQueryToStoryMapper;->displayHelper:Lcom/rctitv/data/util/DisplayHelper;

    if-eqz v10, :cond_c

    .line 46
    iget-object v3, v10, Ltp/x3;->a:Ljava/lang/String;
    ...
    .line 48
    iget-object v5, v7, Ltp/b4;->d:Ljava/lang/String;

    invoke-virtual {v14, v3, v5, v15}, Lcom/rctitv/data/util/DisplayHelper;->combineImagePath(Ljava/lang/String;Ljava/lang/String;I)Ljava/lang/String;
    ...
    .line 49
    iget-object v3, v7, Ltp/b4;->m:Ljava/lang/String;
    ...
    .line 50
    invoke-static {v13, v5, v14}, Ljv/n;->E(Ljava/lang/String;Ljava/lang/String;Z)Z
    ...
    .line 51
    :goto_10
    invoke-virtual {v11, v12}, Lcom/rctitv/data/model/Story$StoryDetail;->setPermalink(Ljava/lang/String;)V

    .line 52
    iget-object v3, v7, Ltp/b4;->j:Ljava/lang/String;

    invoke-virtual {v0, v3}, Lcom/rctitv/data/mapper/StoryQueryToStoryMapper;->isNotNull(Ljava/lang/String;)Z
    ...
    .line 53
    iget-object v5, v0, Lcom/rctitv/data/mapper/StoryQueryToStoryMapper;->displayHelper:Lcom/rctitv/data/util/DisplayHelper;

    if-eqz v10, :cond_10

    .line 54
    iget-object v12, v10, Ltp/x3;->a:Ljava/lang/String;
    ...
    .line 56
    invoke-virtual {v5, v12, v3, v13}, Lcom/rctitv/data/util/DisplayHelper;->combineImagePath(Ljava/lang/String;Ljava/lang/String;I)Ljava/lang/String;
    ...
    :goto_12
    invoke-virtual {v11, v3}, Lcom/rctitv/data/model/Story$StoryDetail;->setImagePath(Ljava/lang/String;)V

    .line 58
    :cond_12
    iget-object v3, v7, Ltp/b4;->l:Ljava/lang/String;
    ...
    .line 60
    invoke-static {v3, v5, v7}, Ljv/n;->e0(Ljava/lang/String;Ljava/lang/String;Z)Z
    ...
    .line 61
    iget-object v5, v10, Ltp/x3;->b:Ljava/lang/String;
    ...
    .line 70
    iget-object v1, v1, Ltp/a4;->c:Ltp/z3;

    if-eqz v1, :cond_19

    iget-object v4, v1, Ltp/z3;->a:Ljava/lang/Integer;
    ...
    .line 71
    iget-object v1, v1, Ltp/z3;->b:Ljava/lang/String;
...
.method public bridge synthetic map(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .line 1
    check-cast p1, Ltp/a4;

    invoke-virtual {p0, p1}, Lcom/rctitv/data/mapper/StoryQueryToStoryMapper;->map(Ltp/a4;)Lcom/rctitv/data/model/StoryModel;
