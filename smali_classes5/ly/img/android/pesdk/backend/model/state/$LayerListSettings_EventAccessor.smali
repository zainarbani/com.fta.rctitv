...
.method public static constructor <clinit>()V
    ...
    .line 5
    .line 6
    sput-object v0, Lly/img/android/pesdk/backend/model/state/$LayerListSettings_EventAccessor;->synchronyCalls:Ljava/util/TreeMap;
    ...
    .line 12
    .line 13
    sput-object v0, Lly/img/android/pesdk/backend/model/state/$LayerListSettings_EventAccessor;->mainThreadCalls:Ljava/util/TreeMap;
    ...
    .line 30
    .line 31
    sput-object v0, Lly/img/android/pesdk/backend/model/state/$LayerListSettings_EventAccessor;->workerThreadCalls:Ljava/util/TreeMap;
    ...
    .line 38
    .line 39
    sput-object v0, Lly/img/android/pesdk/backend/model/state/$LayerListSettings_EventAccessor;->initCall:Lly/img/android/pesdk/backend/model/EventAccessorInterface$Call;
...
.method public static synthetic a(Lly/img/android/pesdk/backend/model/EventSetInterface;Ljava/lang/Object;Z)V
    ...
    invoke-static {p0, p1, p2}, Lly/img/android/pesdk/backend/model/state/$LayerListSettings_EventAccessor;->lambda$static$1(Lly/img/android/pesdk/backend/model/EventSetInterface;Ljava/lang/Object;Z)V
...
.method public static synthetic b(Lly/img/android/pesdk/backend/model/EventSetInterface;Ljava/lang/Object;Z)V
    ...
    invoke-static {p0, p1, p2}, Lly/img/android/pesdk/backend/model/state/$LayerListSettings_EventAccessor;->lambda$static$0(Lly/img/android/pesdk/backend/model/EventSetInterface;Ljava/lang/Object;Z)V
...
.method private static synthetic lambda$static$1(Lly/img/android/pesdk/backend/model/EventSetInterface;Ljava/lang/Object;Z)V
    ...
    .line 10
    .line 11
    new-instance p2, Lly/img/android/pesdk/backend/model/state/$LayerListSettings_EventAccessor$1;

    .line 12
    .line 13
    invoke-direct {p2, p1, p0}, Lly/img/android/pesdk/backend/model/state/$LayerListSettings_EventAccessor$1;-><init>(Lly/img/android/pesdk/backend/model/state/LayerListSettings;Lly/img/android/pesdk/backend/model/EventSetInterface;)V
...
.method public getInitCall()Lly/img/android/pesdk/backend/model/EventAccessorInterface$Call;
    ...
    sget-object v0, Lly/img/android/pesdk/backend/model/state/$LayerListSettings_EventAccessor;->initCall:Lly/img/android/pesdk/backend/model/EventAccessorInterface$Call;
...
.method public getMainThreadCalls()Ljava/util/Map;
    ...
    sget-object v0, Lly/img/android/pesdk/backend/model/state/$LayerListSettings_EventAccessor;->mainThreadCalls:Ljava/util/TreeMap;
...
.method public getSynchronyCalls()Ljava/util/Map;
    ...
    sget-object v0, Lly/img/android/pesdk/backend/model/state/$LayerListSettings_EventAccessor;->synchronyCalls:Ljava/util/TreeMap;
...
.method public getWorkerThreadCalls()Ljava/util/Map;
    ...
    sget-object v0, Lly/img/android/pesdk/backend/model/state/$LayerListSettings_EventAccessor;->workerThreadCalls:Ljava/util/TreeMap;
