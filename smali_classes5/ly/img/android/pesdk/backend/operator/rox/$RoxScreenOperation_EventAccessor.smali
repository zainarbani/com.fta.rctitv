...
.method public static constructor <clinit>()V
    ...
    .line 5
    .line 6
    sput-object v0, Lly/img/android/pesdk/backend/operator/rox/$RoxScreenOperation_EventAccessor;->synchronyCalls:Ljava/util/TreeMap;
    ...
    .line 24
    .line 25
    sput-object v0, Lly/img/android/pesdk/backend/operator/rox/$RoxScreenOperation_EventAccessor;->mainThreadCalls:Ljava/util/TreeMap;
    ...
    .line 31
    .line 32
    sput-object v0, Lly/img/android/pesdk/backend/operator/rox/$RoxScreenOperation_EventAccessor;->workerThreadCalls:Ljava/util/TreeMap;
    ...
    .line 40
    .line 41
    sput-object v0, Lly/img/android/pesdk/backend/operator/rox/$RoxScreenOperation_EventAccessor;->initCall:Lly/img/android/pesdk/backend/model/EventAccessorInterface$Call;
...
.method public static synthetic a(Lly/img/android/pesdk/backend/model/EventSetInterface;Ljava/lang/Object;Z)V
    ...
    invoke-static {p0, p1, p2}, Lly/img/android/pesdk/backend/operator/rox/$RoxScreenOperation_EventAccessor;->lambda$static$0(Lly/img/android/pesdk/backend/model/EventSetInterface;Ljava/lang/Object;Z)V
...
.method public static synthetic b(Lly/img/android/pesdk/backend/model/EventSetInterface;Ljava/lang/Object;Z)V
    ...
    invoke-static {p0, p1, p2}, Lly/img/android/pesdk/backend/operator/rox/$RoxScreenOperation_EventAccessor;->lambda$static$1(Lly/img/android/pesdk/backend/model/EventSetInterface;Ljava/lang/Object;Z)V
...
.method public getInitCall()Lly/img/android/pesdk/backend/model/EventAccessorInterface$Call;
    ...
    sget-object v0, Lly/img/android/pesdk/backend/operator/rox/$RoxScreenOperation_EventAccessor;->initCall:Lly/img/android/pesdk/backend/model/EventAccessorInterface$Call;
...
.method public getMainThreadCalls()Ljava/util/Map;
    ...
    sget-object v0, Lly/img/android/pesdk/backend/operator/rox/$RoxScreenOperation_EventAccessor;->mainThreadCalls:Ljava/util/TreeMap;
...
.method public getSynchronyCalls()Ljava/util/Map;
    ...
    sget-object v0, Lly/img/android/pesdk/backend/operator/rox/$RoxScreenOperation_EventAccessor;->synchronyCalls:Ljava/util/TreeMap;
...
.method public getWorkerThreadCalls()Ljava/util/Map;
    ...
    sget-object v0, Lly/img/android/pesdk/backend/operator/rox/$RoxScreenOperation_EventAccessor;->workerThreadCalls:Ljava/util/TreeMap;
