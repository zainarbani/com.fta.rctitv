...
.method static constructor <clinit>()V
    ...
    invoke-virtual {v0, v6, v7}, Lj$/time/format/p;->l(Lj$/time/temporal/r;I)V

    invoke-virtual {v0, v5}, Lj$/time/format/p;->e(C)V

    sget-object v8, Lj$/time/temporal/a;->DAY_OF_MONTH:Lj$/time/temporal/a;

    invoke-virtual {v0, v8, v7}, Lj$/time/format/p;->l(Lj$/time/temporal/r;I)V

    sget-object v9, Lj$/time/format/v;->STRICT:Lj$/time/format/v;

    sget-object v10, Lj$/time/chrono/u;->d:Lj$/time/chrono/u;

    invoke-virtual {v0, v9, v10}, Lj$/time/format/p;->t(Lj$/time/format/v;Lj$/time/chrono/u;)Lj$/time/format/DateTimeFormatter;
    ...
    invoke-virtual {v11, v9, v10}, Lj$/time/format/p;->t(Lj$/time/format/v;Lj$/time/chrono/u;)Lj$/time/format/DateTimeFormatter;
    ...
    invoke-virtual {v11, v12, v7}, Lj$/time/format/p;->l(Lj$/time/temporal/r;I)V
    ...
    invoke-virtual {v11, v14, v7}, Lj$/time/format/p;->l(Lj$/time/temporal/r;I)V
    ...
    invoke-virtual {v11, v15, v7}, Lj$/time/format/p;->l(Lj$/time/temporal/r;I)V
    ...
    invoke-virtual {v11, v9, v13}, Lj$/time/format/p;->t(Lj$/time/format/v;Lj$/time/chrono/u;)Lj$/time/format/DateTimeFormatter;
    ...
    invoke-virtual {v7, v9, v13}, Lj$/time/format/p;->t(Lj$/time/format/v;Lj$/time/chrono/u;)Lj$/time/format/DateTimeFormatter;
    ...
    invoke-virtual {v7, v9, v10}, Lj$/time/format/p;->t(Lj$/time/format/v;Lj$/time/chrono/u;)Lj$/time/format/DateTimeFormatter;
    ...
    invoke-virtual {v0, v7, v11}, Lj$/time/format/p;->l(Lj$/time/temporal/r;I)V
    ...
    invoke-virtual {v0, v7, v3, v4, v2}, Lj$/time/format/p;->j(Lj$/time/temporal/r;IILj$/time/format/w;)Lj$/time/format/p;
    ...
    invoke-virtual {v0, v2, v4}, Lj$/time/format/p;->l(Lj$/time/temporal/r;I)V
    ...
    invoke-virtual {v0, v9, v5}, Lj$/time/format/p;->t(Lj$/time/format/v;Lj$/time/chrono/u;)Lj$/time/format/DateTimeFormatter;
    ...
    invoke-virtual {v0, v1, v3}, Lj$/time/format/p;->l(Lj$/time/temporal/r;I)V

    const/4 v5, 0x2

    invoke-virtual {v0, v6, v5}, Lj$/time/format/p;->l(Lj$/time/temporal/r;I)V

    invoke-virtual {v0, v8, v5}, Lj$/time/format/p;->l(Lj$/time/temporal/r;I)V
    ...
    invoke-virtual {v3, v8, v4, v2, v0}, Lj$/time/format/p;->j(Lj$/time/temporal/r;IILj$/time/format/w;)Lj$/time/format/p;
    ...
    invoke-virtual {v3, v1, v4}, Lj$/time/format/p;->l(Lj$/time/temporal/r;I)V

    invoke-virtual {v3, v0}, Lj$/time/format/p;->e(C)V

    invoke-virtual {v3, v12, v2}, Lj$/time/format/p;->l(Lj$/time/temporal/r;I)V

    const/16 v1, 0x3a

    invoke-virtual {v3, v1}, Lj$/time/format/p;->e(C)V

    invoke-virtual {v3, v14, v2}, Lj$/time/format/p;->l(Lj$/time/temporal/r;I)V
    ...
    invoke-virtual {v3, v1, v2}, Lj$/time/format/p;->l(Lj$/time/temporal/r;I)V
    ...
    invoke-virtual {v3, v0, v1}, Lj$/time/format/p;->t(Lj$/time/format/v;Lj$/time/chrono/u;)Lj$/time/format/DateTimeFormatter;

    return-void
.end method

.method constructor <init>(Lj$/time/format/f;Ljava/util/Locale;Lj$/time/format/v;Lj$/time/chrono/u;)V
    .locals 2
    ...
    iput-object p1, p0, Lj$/time/format/DateTimeFormatter;->c:Lj$/time/format/u;
    ...
    iput-object p1, p0, Lj$/time/format/DateTimeFormatter;->e:Lj$/time/z;
...
.method public final a(Lj$/time/temporal/n;)Ljava/lang/String;
    ...
    :try_start_1
    invoke-virtual {p1, v1, v0}, Lj$/time/format/f;->e(Lj$/time/format/r;Ljava/lang/StringBuilder;)Z
    :try_end_1
...
.method public final e()Lj$/time/z;
    ...
    iget-object v0, p0, Lj$/time/format/DateTimeFormatter;->e:Lj$/time/z;
