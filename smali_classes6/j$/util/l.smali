...
.method public static a(Lj$/util/B;Ljava/util/function/Consumer;)V
    .locals 1
    ...
    invoke-interface {p0, p1}, Lj$/util/B;->forEachRemaining(Ljava/util/function/DoubleConsumer;)V
    ...
    invoke-interface {p0, v0}, Lj$/util/B;->forEachRemaining(Ljava/util/function/DoubleConsumer;)V
...
.method public static c(Lj$/util/G;Ljava/util/function/Consumer;)V
    .locals 1
    ...
    invoke-interface {p0, p1}, Lj$/util/G;->forEachRemaining(Ljava/util/function/LongConsumer;)V
    ...
    invoke-interface {p0, v0}, Lj$/util/G;->forEachRemaining(Ljava/util/function/LongConsumer;)V
...
.method public static d(Lj$/util/B;Ljava/util/function/Consumer;)Z
    .locals 1
    ...
    invoke-interface {p0, p1}, Lj$/util/B;->tryAdvance(Ljava/util/function/DoubleConsumer;)Z
    ...
    invoke-interface {p0, v0}, Lj$/util/B;->tryAdvance(Ljava/util/function/DoubleConsumer;)Z
...
.method public static f(Lj$/util/G;Ljava/util/function/Consumer;)Z
    ...
    invoke-interface {p0, p1}, Lj$/util/G;->tryAdvance(Ljava/util/function/LongConsumer;)Z
    ...
    invoke-interface {p0, v0}, Lj$/util/G;->tryAdvance(Ljava/util/function/LongConsumer;)Z
