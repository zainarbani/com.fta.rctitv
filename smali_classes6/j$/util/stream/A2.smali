...
.method constructor <init>(Lj$/util/stream/c;IJJ)V
    ...
    iput-wide p3, p0, Lj$/util/stream/A2;->s:J

    iput-wide p5, p0, Lj$/util/stream/A2;->t:J

    invoke-direct {p0, p1, p2}, Lj$/util/stream/m0;-><init>(Lj$/util/stream/c;I)V

    return-void
.end method

.method static T0(Lj$/util/G;JJJ)Lj$/util/G;
    .locals 8
    ...
    invoke-direct/range {v2 .. v7}, Lj$/util/stream/K3;-><init>(Lj$/util/G;JJ)V
...
.method final I0(Lj$/util/Spliterator;Lj$/util/stream/c;Ljava/util/function/IntFunction;)Lj$/util/stream/J0;
    ...
    iget-wide v4, v9, Lj$/util/stream/A2;->s:J

    iget-wide v7, v9, Lj$/util/stream/A2;->t:J
    ...
    invoke-static {p2, v0, v10}, Lj$/util/stream/A0;->b0(Lj$/util/stream/A0;Lj$/util/Spliterator;Z)Lj$/util/stream/H0;
    ...
    iget-wide v1, v9, Lj$/util/stream/A2;->s:J

    iget-wide v3, v9, Lj$/util/stream/A2;->t:J

    move-wide v5, v7

    invoke-static/range {v0 .. v6}, Lj$/util/stream/A2;->T0(Lj$/util/G;JJJ)Lj$/util/G;

    move-result-object v0

    invoke-static {p0, v0, v10}, Lj$/util/stream/A0;->b0(Lj$/util/stream/A0;Lj$/util/Spliterator;Z)Lj$/util/stream/H0;
    ...
    iget-wide v7, v9, Lj$/util/stream/A2;->s:J

    iget-wide v11, v9, Lj$/util/stream/A2;->t:J
...
.method final J0(Lj$/util/stream/c;Lj$/util/Spliterator;)Lj$/util/Spliterator;
    ...
    check-cast v8, Lj$/util/G;

    iget-wide v9, p0, Lj$/util/stream/A2;->s:J

    iget-wide p1, p0, Lj$/util/stream/A2;->t:J
    ...
    invoke-direct/range {v7 .. v12}, Lj$/util/stream/E3;-><init>(Lj$/util/G;JJ)V
    ...
    iget-wide v1, p0, Lj$/util/stream/A2;->s:J

    iget-wide v3, p0, Lj$/util/stream/A2;->t:J
    ...
    iget-wide v5, p0, Lj$/util/stream/A2;->s:J

    iget-wide v7, p0, Lj$/util/stream/A2;->t:J
